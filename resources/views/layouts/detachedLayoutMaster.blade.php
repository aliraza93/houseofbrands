...
<head>
  ...
  <title>@yield('title') - House Of Brands Vuejs, HTML & Laravel Admin Dashboard Template</title>
  <link rel="shortcut icon" type="image/x-icon" href="{{ asset('images/logo/house-of-brands-logo-small.png') }}" />
