    ...
    <div class="card mb-0">
      <div class="card-body">
        <a href="javascript:void(0);" class="brand-logo">
          ...
          <img src="{{ asset('images/logo/house-of-brands-logo-small.png') }}" style="width: 4rem; height: auto;" alt="">
          {{-- <h2 class="brand-text text-primary ml-1">House Of Brands</h2> --}}
        </a>

        <h4 class="card-title mb-1">Welcome to House Of Brands! 👋</h4>
